...
const meetings = [
    {
        ...
        startDatetime: '2024-05-11T10:00',
...
export default function Calendar1() {
    ...
    return (
        <div style={{ display: "flex", flexDirection: "column" }}>
            <div style={{ width: "100%", marginBottom: "30px", fontSize: "30px", fontWeight: "bold", display: "flex", justifyContent: "center" }}>
                <h1 style={{ textAlign: "center", textDecoration: 'underline' }}>Lịch  Của Bạn</h1>
            </div>


            <div className="pt-1 h-80">
